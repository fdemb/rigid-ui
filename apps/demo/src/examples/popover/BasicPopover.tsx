...
/*
 * The positioner supplies the arrow's cross-axis offset so it stays centered on the
 * anchor; pushing it out to the popup's edge on the side axis is up to the consumer.
 */
const arrow =
  ...
  return (
    <Popover.Root>
      <Popover.Trigger class={trigger}>
        <span class={press}>Notifications</span>
      </Popover.Trigger>
      <Popover.Portal>
