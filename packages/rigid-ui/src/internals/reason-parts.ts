/**
 * Solid port of Base UI's `reference/base-ui/packages/react/src/internals/reason-parts.ts`.
 * Flat string constants so reason unions stay tree-shakeable and greppable.
 */
