...
/**
 * Solid port of Base UI's `reference/base-ui/packages/react/src/utils/popupStateMapping.ts`.
 * Shared `data-*` vocabulary for every popup family member (Dialog, Popover, and later Menu,
 * Select, Tooltip, …).
 */
